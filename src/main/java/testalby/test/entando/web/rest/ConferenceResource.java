package testalby.test.entando.web.rest;

import testalby.test.entando.domain.Conference;
import testalby.test.entando.repository.ConferenceRepository;
import testalby.test.entando.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link testalby.test.entando.domain.Conference}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ConferenceResource {
    ...
    private static final String ENTITY_NAME = "testalbyConference";
