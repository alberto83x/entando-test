package testalby.test.entando.config.timezone;

import testalby.test.entando.TestalbyApp;
import testalby.test.entando.config.TestSecurityConfiguration;
import testalby.test.entando.repository.timezone.DateTimeWrapper;
import testalby.test.entando.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@SpringBootTest(classes = {TestalbyApp.class, TestSecurityConfiguration.class})
